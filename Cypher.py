...
text_to_encrypt = input("Please Enter your text/message: ")
...
if key > 25 or key < 0:
   ...
   print("Your shift length should be between 0 and 25 ")
...
print(text_to_encrypt,"has been encrypted as",encrypted_text)